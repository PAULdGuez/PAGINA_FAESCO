...
import { ArrowLeft, CheckCircle, CreditCard, Building2, Truck, Package, User, MapPin, Phone, Mail } from "lucide-react";
...
const Checkout = () => {
  ...
  // If no cart item, redirect back
  if (!cartItem && !isConfirmed) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <Card className="max-w-md w-full mx-4">
          <CardContent className="pt-6 text-center">
            <Package className="w-16 h-16 text-muted-foreground mx-auto mb-4" />
            <h2 className="text-xl font-semibold mb-2">No hay productos en tu orden</h2>
            <p className="text-muted-foreground mb-6">
              Selecciona un producto de nuestro catálogo para continuar.
            </p>
  ...
  const unitPrice = cartItem ? parsePrice(cartItem.price) : 0;
        ...
        <Card className="max-w-lg w-full">
          <CardContent className="pt-8 text-center">
            ...
            <div className="bg-muted/50 rounded-lg p-4 mb-6 text-left">
              ...
              {/* <p className="font-mono font-bold text-primary">#{Date.now().toString(36).toUpperCase()}</p> */}
            </div>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="flex items-start space-x-4 pb-4 border-b">
                    <div className="w-16 h-16 bg-primary/10 rounded-lg flex items-center justify-center">
                      <span className="text-3xl">{cartItem?.image}</span>
                    </div>
                  ...
                  <div className="py-4 border-b">
                    <Label htmlFor="quantity" className="text-sm text-muted-foreground">Cantidad</Label>
                  ...
                  <div className="py-4 space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span>{cartItem?.price} {cartItem?.unit}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground">Cantidad:</span>
                      <span>{quantity} {quantity === 1 ? 'pieza' : 'piezas'}</span>
                    </div>
                    <div className="flex justify-between text-sm">
